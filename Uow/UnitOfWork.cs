...
public class UnitOfWork : IUnitOfWork
{
    ...
    public const string UnitOfWorkReservationName = "_EqnActionUnitOfWork";

    public Guid Id { get; } = Guid.NewGuid();

    public IEqnUnitOfWorkOptions Options { get; private set; }
    ...
    private readonly EqnUnitOfWorkDefaultOptions _defaultOptions;
    ...
    public UnitOfWork(
        ...
        IOptions<EqnUnitOfWorkDefaultOptions> options)
    {
    ...
    public virtual void Initialize(EqnUnitOfWorkOptions options)
    {
